from .views import efetuarChamado, cadastroRecurso, home, cadastroRecurso, cad_local, listar_local, success_page, cadastroTipoRecurso, listarRecursos, cadastroReserva, reserva_recurso
